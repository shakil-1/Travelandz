...
const Banner = () => {
  ...
  <div className=" lg:w-[896px] text-center mx-auto ">
...
<div className="bg-[#FFF]   rounded-20 p-5  mx-auto md:mt-10 mt-10 lg:mt-[60px]  ">
...
<hr />
<div className=" flex flex-wrap lg:flex items-end   gap-5 md:mt-7 ">
  <div>
    <h3 className="font-medium  mt-4 ">Destination</h3>
  ...
  <div >
    <h3 className="font-medium mt-4 ">Check-in</h3>
  ...
  <div>
    <h3 className="font-medium mt-4 ">Check-out</h3>
    <input className="outline-none border rounded-full w-[150px] lg:w-[160px] h-[47px] pl-6  mt-2"  type="text" placeholder="DD/MM/YYYY" name="" id="" />
  </div>
  <div>
    <h3 className="font-medium mt-4 ">Guests</h3>
    <input className="outline-none border rounded-full w-[140px] h-[47px] pl-6  mt-2"  type="text" placeholder="1" name="" id="" />
  </div>

<button  className="bg-gradient rounded-full w-[321px] lg:w-[180px] h-[47px] py-3 px-8 text-[#FFF] lg:mt-8 " >Explore Plans</button>
  </div>
</div>
  </div>
